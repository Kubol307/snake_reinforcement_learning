...
nnBlobPath = '/home/jakub/python/hand_gesture_recognition/yolov8n/best.blob'
print(nnBlobPath)

camera_id = '19443010913AEE1200'
...
with dai.Device(pipeline, device_info) as device:
    ...
    # object_publisher = rospy.Publisher('/asv_vision/front_cam/detections', ObjectHypothesisWithPose, queue_size=10)
    # frame_publisher = rospy.Publisher('/asv_vision/front_cam/raw', Image, queue_size=10)
    # bridge = CvBridge()
