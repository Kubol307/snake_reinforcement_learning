...
class GameEnv(gym.Env):
    def __init__(self, train=True):
        ...
        self.observation_space = spaces.Box(low=0, high=1000, shape=(SNAKE_LEN_GOAL*2+4+2,), dtype=np.int32)
...
def main():
    ...
    model = PPO.load('/home/jakub/python/models/dlugi_trening_no_eucl/7030000', env)
